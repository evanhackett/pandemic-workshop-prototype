...
const random0 = randomF({ random: () => 0, GRID_RESOLUTION: 100 })
const random99 = randomF({ random: () => 0.999999999, GRID_RESOLUTION: 100 })

test('simulation should init NUM_ACTORS actors with random starting positions', t => {

  let simulation = new Simulation({ NUM_ACTORS: 1, RED: constants.RED, random: random0 })
  ...
  simulation = new Simulation({ NUM_ACTORS: 100, RED: constants.RED, random: random99 })
  t.equal(Array.isArray(simulation.actors), true)
